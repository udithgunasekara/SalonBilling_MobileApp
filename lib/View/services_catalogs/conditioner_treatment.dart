...
class ConditionerTreatment extends StatefulWidget {
  const ConditionerTreatment({super.key});

  @override
  State<ConditionerTreatment> createState() => _ConditionerTreatmentState();
}

class _ConditionerTreatmentState extends State<ConditionerTreatment> {
  double price = 400.00;
                  ...
                  child: GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: isEditing
                          ...
                          : Text(
                              'Conditioner : Rs ${price.toStringAsFixed(2)}',
                              style: const TextStyle(
                                fontSize: 24,
                                fontWeight: FontWeight.w400,
                                color: Colors.black,
