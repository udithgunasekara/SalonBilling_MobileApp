...
class Perming extends StatefulWidget {
  const Perming({super.key});

  @override
  State<Perming> createState() => _PermingState();
}

class _PermingState extends State<Perming> {
  double price = 400.00;
  ...
  void _toggleEdit() {
    setState(() {
      if (isEditing) {
        ...
        _viewModel.notifychanges(price.toInt().toString(), 'Perming');
      } else {
                  ...
                  child: GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: isEditing
                          ...
                          : Text(
                              'Perming : Rs  ${price.toStringAsFixed(2)}',
                              style: const TextStyle(
                                fontSize: 24,
                                fontWeight: FontWeight.w400,
                                color: Colors.black,
