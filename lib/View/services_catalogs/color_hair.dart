...
class ColorHair extends StatefulWidget {
  const ColorHair({super.key});

  @override
  State<ColorHair> createState() => _ColorHairState();
}

class _ColorHairState extends State<ColorHair> {
  double price = 400.00;
                  ...
                  child: GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: isEditing
                          ...
                          : Text(
                              'Color : Rs ${price.toStringAsFixed(2)}',
                              style: const TextStyle(
                                fontSize: 24,
                                fontWeight: FontWeight.w400,
                                color: Colors.black,
