...
class Rebonding extends StatefulWidget {
  const Rebonding({super.key});

  @override
  State<Rebonding> createState() => _RebondingState();
}

class _RebondingState extends State<Rebonding> {
  double price = 400.00;
