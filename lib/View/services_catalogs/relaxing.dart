...
class Relaxing extends StatefulWidget {
  const Relaxing({super.key});

  @override
  State<Relaxing> createState() => _RelaxingState();
}

class _RelaxingState extends State<Relaxing> {
  double price = 400.00;
                  ...
                  child: GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: isEditing
                          ...
                          : Text(
                              'Relaxing : Rs ${price.toStringAsFixed(2)}',
                              style: const TextStyle(
                                fontSize: 24,
                                fontWeight: FontWeight.w400,
                                color: Colors.black,
